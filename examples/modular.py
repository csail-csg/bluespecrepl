...
repl_eval('sim')
repl_eval('sim.io')
repl_eval('sim.internals')
repl_eval('sim.bsv')
repl_eval('sim.bsv.submod_2')
repl_eval('sim.interface.enq(17)')
repl_eval('sim.bsv.submod_2.inner_forward_2.can_fire')
repl_exec('while not sim.bsv.submod_2.inner_forward_2.can_fire:\n    sim.step(1)')
repl_eval('sim.bsv.submod_2.inner_forward_2.can_fire')
repl_eval('sim.bsv.submod_2.inner_forward_2()')
repl_eval('sim.bsv.submod_2.inner_forward_2.can_fire')
